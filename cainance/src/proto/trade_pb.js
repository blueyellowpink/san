...
proto.trade.Trade.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.trade.MatchedPair.toObject, includeInstance)
  };
...
proto.trade.Trade.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.trade.MatchedPair.serializeBinaryToWriter
    );
  }
};
...
proto.trade.Trade.prototype.getTradesList = function() {
  return /** @type{!Array<!proto.trade.MatchedPair>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.trade.MatchedPair, 3));
};
...
proto.trade.MatchedPair.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.trade.MatchedOrder.toObject, includeInstance)
  };
...
proto.trade.MatchedPair.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.trade.MatchedOrder.serializeBinaryToWriter
    );
  }
...
proto.trade.MatchedPair.prototype.getInitOrder = function() {
  return /** @type{?proto.trade.MatchedOrder} */ (
    jspb.Message.getWrapperField(this, proto.trade.MatchedOrder, 2));
};
...
proto.trade.MatchedPair.prototype.getMatchedOrdersList = function() {
  return /** @type{!Array<!proto.trade.MatchedOrder>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.trade.MatchedOrder, 3));
};
 ...
 * @return {number}
 */
proto.trade.MatchedOrder.prototype.getUserId = function() {
 ...
 * @return {!proto.trade.MatchedOrder} returns this
 */
proto.trade.MatchedOrder.prototype.setUserId = function(value) {
