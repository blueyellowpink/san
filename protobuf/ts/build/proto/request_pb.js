...
proto.request.Add.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getOrder();
    if (f != null) {
        writer.writeMessage(1, f, proto_order_pb.Order.serializeBinaryToWriter);
    }
};
/**
...
proto.request.Add.prototype.getOrder = function () {
    return /** @type{?proto.order.Order} */ (jspb.Message.getWrapperField(this, proto_order_pb.Order, 1));
};
/**
...
proto.request.Request.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getAdd();
    if (f != null) {
        writer.writeMessage(1, f, proto.request.Add.serializeBinaryToWriter);
    }
    f = message.getCancel();
    if (f != null) {
        writer.writeMessage(2, f, proto.request.Cancel.serializeBinaryToWriter);
    }
    f = message.getModify();
    if (f != null) {
        writer.writeMessage(3, f, proto.request.Modify.serializeBinaryToWriter);
    }
};
/**
 * optional Add add = 1;
...
proto.request.Request.prototype.getAdd = function () {
    return /** @type{?proto.request.Add} */ (jspb.Message.getWrapperField(this, proto.request.Add, 1));
};
/**
...
proto.request.Request.prototype.getCancel = function () {
    return /** @type{?proto.request.Cancel} */ (jspb.Message.getWrapperField(this, proto.request.Cancel, 2));
};
/**
...
proto.request.Request.prototype.getModify = function () {
    return /** @type{?proto.request.Modify} */ (jspb.Message.getWrapperField(this, proto.request.Modify, 3));
};
/**
...
//# sourceMappingURL=request_pb.js.map