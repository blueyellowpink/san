...
proto.orderbook.OrderBook.toObject = function(includeInstance, msg) {
  var f, obj = {
    askPairsList: jspb.Message.toObjectList(msg.getAskPairsList(),
    proto.orderbook.PriceSizePair.toObject, includeInstance),
    bidPairsList: jspb.Message.toObjectList(msg.getBidPairsList(),
    proto.orderbook.PriceSizePair.toObject, includeInstance)
  };
...
proto.orderbook.OrderBook.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.orderbook.PriceSizePair.serializeBinaryToWriter
    );
  }
...
proto.orderbook.OrderBook.prototype.getAskPairsList = function() {
  return /** @type{!Array<!proto.orderbook.PriceSizePair>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.orderbook.PriceSizePair, 1));
};
...
proto.orderbook.OrderBook.prototype.getBidPairsList = function() {
  return /** @type{!Array<!proto.orderbook.PriceSizePair>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.orderbook.PriceSizePair, 2));
};
